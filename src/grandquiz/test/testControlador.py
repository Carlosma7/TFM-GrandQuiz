...
# Test de responder desafio
def test_estado_partida_controlador():
	# Crear controlador
	c = Controlador()
	# Crear objetos jugador
	j1 = Jugador("Test75", "Test75")
	j1.set_edad("edad0")
	j2 = Jugador("Test76", "Test76")
	j2.set_edad("edad1")
	j3 = Jugador("Test77", "Test77")
	j3.set_edad("edad0")
	j4 = Jugador("Test78", "Test78")
	j4.set_edad("edad1")
	# Crear jugadores
	c.registrar_jugador(j1)
	c.registrar_jugador(j2)
	...
	estado_eq1, estado_eq2 = c.estado_partida(p.get_chat(), j1.get_nombre_usuario())
	# Comprobar estado de partida
	assert_that(estado_eq1).is_type_of(dict)
	assert_that(estado_eq2).is_type_of(dict)
	# Borrar jugador de test
	c.mongo.jugadores.delete_one({'nombre_usuario':j1.get_nombre_usuario()})
	# Borrar jugador de test
	c.mongo.jugadores.delete_one({'nombre_usuario':j2.get_nombre_usuario()})
...
# Test de comprobar medallas de un jugador en un duelo
def test_comprobar_medalla_duelo_controlador():
	# Crear controlador
	c = Controlador()
	# Crear objetos jugador
	j1 = Jugador("Test91", "Test91")
	j1.set_edad("edad0")
	j2 = Jugador("Test92", "Test92")
	j2.set_edad("edad1")
	# Crear jugadores
	c.registrar_jugador(j1)
	c.registrar_jugador(j2)
	# Crear objeto duelo
	d1 = Duelo("Test11", j1.get_nombre_usuario())
	d2 = Duelo("Test12", j2.get_nombre_usuario())
	# Crear duelo
	c.crear_duelo(d1, j1.get_nombre_usuario())
	turno, ava_turno, pregunta, categoria, chat1, chat2 = c.crear_duelo(d2, j2.get_nombre_usuario())
	# Comprobar que el equipo no tiene la medalla de la categoria actual
	medalla, categoria = c.comprobar_medalla_duelo(chat1)
	# Comprobar que es falso
	assert_that(medalla).is_false()
	# Borrar jugador de test
	c.mongo.jugadores.delete_one({'nombre_usuario':j1.get_nombre_usuario()})
...
# Test de terminar un duelo
def test_terminar_duelo_controlador():
	# Crear controlador
	c = Controlador()
	# Crear objetos jugador
	j1 = Jugador("Test93", "Test93")
	j1.set_edad("edad0")
	j2 = Jugador("Test94", "Test94")
	j2.set_edad("edad1")
	# Crear jugadores
	c.registrar_jugador(j1)
	c.registrar_jugador(j2)
	# Crear objeto duelo
	d1 = Duelo("Test13", j1.get_nombre_usuario())
	d2 = Duelo("Test14", j2.get_nombre_usuario())
	# Crear duelo
	c.crear_duelo(d1, j1.get_nombre_usuario())
	turno, ava_turno, pregunta, categoria, chat1, chat2 = c.crear_duelo(d2, j2.get_nombre_usuario())
	# Obtener duelo de la BD
	duelo = c.mongo.duelos.find_one({'chat': chat1})
	# Comprobar que el duelo existe
	assert_that(duelo).is_not_none()
	# Terminar duelo
	c.terminar_duelo(chat1)
	# Obtener duelo de la BD
	duelo = c.mongo.duelos.find_one({'chat': chat1})
	# Comprobar que la partida existe
	assert_that(duelo).is_none()
	# Borrar jugador de test
	c.mongo.jugadores.delete_one({'nombre_usuario':j1.get_nombre_usuario()})
	c.mongo.jugadores.delete_one({'nombre_usuario':j2.get_nombre_usuario()})
	# Borrar estadistica de test
...
# Test de comprobar estado del duelo
def test_estado_duelo_controlador():
	# Crear controlador
	c = Controlador()
	# Crear objetos jugador
	j1 = Jugador("Test95", "Test95")
	j1.set_edad("edad0")
	j2 = Jugador("Test96", "Test96")
	j2.set_edad("edad1")
	# Crear jugadores
	c.registrar_jugador(j1)
	c.registrar_jugador(j2)
	# Crear objeto duelo
	d1 = Duelo("Test15", j1.get_nombre_usuario())
	d2 = Duelo("Test16", j2.get_nombre_usuario())
	# Crear duelo
	c.crear_duelo(d1, j1.get_nombre_usuario())
	turno, ava_turno, pregunta, categoria, chat1, chat2 = c.crear_duelo(d2, j2.get_nombre_usuario())
	# Obtener estado de partida
	estado1, estado2 = c.estado_duelo(chat1, j1.get_nombre_usuario())
	# Comprobar estado de partida
	assert_that(estado1).is_type_of(dict)
	assert_that(estado2).is_type_of(dict)
	# Borrar jugador de test
	c.mongo.jugadores.delete_one({'nombre_usuario':j1.get_nombre_usuario()})
	c.mongo.jugadores.delete_one({'nombre_usuario':j2.get_nombre_usuario()})
	# Borrar estadistica de test
...
# Test de almacenar mensaje de pregunta del duelo
def test_almacenar_mensaje_duelo_controlador():
	# Crear controlador
	c = Controlador()
	# Crear objetos jugador
	j1 = Jugador("Test97", "Test97")
	j1.set_edad("edad0")
	j2 = Jugador("Test98", "Test98")
	j2.set_edad("edad1")
	# Crear jugadores
	c.registrar_jugador(j1)
	c.registrar_jugador(j2)
	# Crear objeto duelo
	d1 = Duelo("Test17", j1.get_nombre_usuario())
	d2 = Duelo("Test18", j2.get_nombre_usuario())
	# Crear duelo
	c.crear_duelo(d1, j1.get_nombre_usuario())
	turno, ava_turno, pregunta, categoria, chat1, chat2 = c.crear_duelo(d2, j2.get_nombre_usuario())
	# Obtener duelo de la BD
	duelo = c.mongo.duelos.find_one({'chat': chat1})
	duelo = Duelo.from_dict(duelo)
	# Obtener el mensaje del duelo
	mensaje_inicial = duelo.get_mensaje_pregunta1()
	# Cambiar el mensaje de la pregunta
	duelo.set_mensaje_pregunta1(9999)
	# Comprobar que el mensaje de la partida ha cambiado
	assert_that(mensaje_inicial).is_not_equal_to(duelo.get_mensaje_pregunta1())
	# Borrar jugador de test
	c.mongo.jugadores.delete_one({'nombre_usuario':j1.get_nombre_usuario()})
	c.mongo.jugadores.delete_one({'nombre_usuario':j2.get_nombre_usuario()})
	# Borrar estadistica de test
...
# Test de obtener mensaje de pregunta del duelo
def test_obtener_mensaje_duelo_controlador():
	# Crear controlador
	c = Controlador()
	# Crear objetos jugador
	j1 = Jugador("Test99", "Test99")
	j1.set_edad("edad0")
	j2 = Jugador("Test100", "Test100")
	j2.set_edad("edad1")
	# Crear jugadores
	c.registrar_jugador(j1)
	c.registrar_jugador(j2)
	# Crear objeto duelo
	d1 = Duelo("Test19", j1.get_nombre_usuario())
	d2 = Duelo("Test20", j2.get_nombre_usuario())
	# Crear duelo
	c.crear_duelo(d1, j1.get_nombre_usuario())
	turno, ava_turno, pregunta, categoria, chat1, chat2 = c.crear_duelo(d2, j2.get_nombre_usuario())
	# Obtener duelo de la BD
...
# Test de obtener estado del duelo
def test_estado_duelo_controlador():
	# Crear controlador
	c = Controlador()
	# Crear objetos jugador
	j1 = Jugador("Test101", "Test101")
	j1.set_edad("edad0")
	j2 = Jugador("Test102", "Test102")
	j2.set_edad("edad1")
	# Crear jugadores
	c.registrar_jugador(j1)
	c.registrar_jugador(j2)
	# Crear objeto duelo
	d1 = Duelo("Test21", j1.get_nombre_usuario())
	d2 = Duelo("Test22", j2.get_nombre_usuario())
	# Crear duelo
	c.crear_duelo(d1, j1.get_nombre_usuario())
	turno, ava_turno, pregunta, categoria, chat1, chat2 = c.crear_duelo(d2, j2.get_nombre_usuario())
	# Obtener estado de partida
