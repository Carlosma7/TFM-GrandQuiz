...
class Partida():
	...
	def add_preguntas(self):
		p = Pregunta(1, "¿Cuál es el continente más extenso del planeta?", ["América", "Europa", "Asia", "África"], 3)
		self.__preguntas.append(p)
		p = Pregunta(2, "¿De qué estilo arquitectónico es la catedral de Barcelona?", ["Barroco", "Gótico", "Románico", "Renacentista"], 2)
		self.__preguntas.append(p)
		p = Pregunta(3, "En qué ciudad se encuentra la fuente de Cibeles?", ["Sevilla", "Valencia", "Granada", "Madrid"], 4)
		self.__preguntas.append(p)
		p = Pregunta(4, "De las siguientes palabras señala cuál de ellas está escrita correctamente:", ["Excarbar", "Escarvar", "Excarvar", "Escarbar"], 4)
		self.__preguntas.append(p)
		p = Pregunta(5, "¿Cuál de las siguientes palabras no es un verbo?", ["Placer", "Traer", "Romper", "Perder"], 1)
		self.__preguntas.append(p)
		p = Pregunta(6, "¿Qué sustancia se encuentra en el interior de un termómetro?", ["Agua", "Líquido refrigerado", "Agua con gas", "Mercurio"], 4)
		self.__preguntas.append(p)
		p = Pregunta(7, "La capital de Dinamarca es:", ["Zagreb", "Liubliana", "Bratislava", "Copenhague"], 4)
		self.__preguntas.append(p)
		p = Pregunta(8, "¿Cuál fue la primera civilización histórica?", ["Mesopotamia", "Romana", "Griega", "Egipcia"], 1)
		self.__preguntas.append(p)
		p = Pregunta(9, "El pico de Mulhacén se encuentra en:", ["Málaga", "Almería", "Granada", "Jaén"], 3)
		self.__preguntas.append(p)
		p = Pregunta(10, "La ciudad de Sevilla forma parte de la comunidad autónoma de:", ["Murcia", "Andalucía", "Asturias", "Extremadura"], 2)
		self.__preguntas.append(p)
		p = Pregunta(11, "¿Que representa el elemento químico H2O?", ["Sodio", "Agua", "Sal", "Hidrógeno"], 3)
		self.__preguntas.append(p)
